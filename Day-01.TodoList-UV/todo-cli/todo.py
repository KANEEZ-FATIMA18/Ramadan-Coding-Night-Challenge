...
# import json #to save the data in json format
# import os #to check if the file exists


# TODO_FILE = "todo.json" # This variable hold todo.json file data

# # Load the tasks from the TODO file
# def load_tasks():
...
# # Save the tasks to the TODO file   
...
#     tasks = load_tasks() # Load the tasks
#     if 0 < task_number <= len(tasks): # Check if the task number is valid
#         removed_task = tasks.pop(task_number - 1) # Remove the
#         save_tasks(tasks) # Save the updated tasks
#         click.echo(f'Removed task: {removed_task["task"]}') # Print the removed task
#     else:
#         click.echo("invalid task number.") # If the task number is invalid, print an error message
